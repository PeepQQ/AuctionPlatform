...
import { InputField, Textarea, Select } from "@/shared/ui/form"
...
export const renderField = (
    ...
    switch (field.field) {
        case 'input':
            return <InputField 
                        key={field.name}
                        name={field.name as Path<CreateLotFormValues>} 
                        label={field.label} 
                        type={field.type} 
                        placeholder={field.placeholder} 
                        onlyNum={field.onlyNum} 
                        register={register} 
                        error={(errors as any)[field.name as Path<CreateLotFormValues>]?.message} 
